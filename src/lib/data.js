...
export const DESTINATIONS = [
  ...
  { id:'pinaru-park', name:'Pinaru Park', type:'keluarga', area:'Ciater, Subang',
    ...
    gallery:[PR(1), PR(2), PR(3), PR(5), PR(6), PR(7)] },
...
export const MEDIA_VIDEOS = [
  {
    id: 'video-1',
    title: 'Review & Dokumentasi: Nimo Eye Bianglala Tertinggi di Indonesia & Nimo Sky Bridge',
    channel: 'Liputan Wisata Indonesia',
    badge: 'Dokumentasi Video',
    date: '2024',
    views: 'Viral di Media Sosial',
  ...
  {
    id: 'video-2',
    title: 'Malam Anugerah CNN Indonesia Awards Jawa Barat 2024: Jawa Barat Menyala',
    channel: 'CNN Indonesia Official',
    badge: 'Malam Penganugerahan',
    date: '17 September 2024',
    views: 'Liputan Resmi TV',
